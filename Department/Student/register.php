  ...
  <div class="reg_img">
    <div class="box2">
      ...
      <form name="Registration" action="" method="post">
        <h2 style="text-align: center; font-size: 30px; color: brown; margin-bottom: 30px;">Student Registration</h2>
        ...
        <div class="login">
          ...
          <input class="btn btn-default" type="submit" name="submit" value="Sign Up" style="width: 170px; height: 40px"> </div>
      </form>
