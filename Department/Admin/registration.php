...
<section>
  <div class="reg_img" style="background-image: url(images/lin.jpg);width: 1550px;padding: 20px;">

    <div class="box2">
        <h1 style="text-align: center; font-size: 35px;font-family: Lucida Console;">  Department Library</h1>
